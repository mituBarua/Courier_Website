...
//        let widthCss = `${$('#navbarSupportedContentMiddle .navbar-nav').width()}px !important`;
//        $('#dropdown_hack_style').html(
//            `#serviceDropdown .dropdown-menu {left: -65.6562px  !important; width: 880.234px !important;}`
//        )
//    }
...
$(document).ready(function () {
    ...
    if (fileName != "") {
        ...
        if (fileName == "pickup-drop") {
            $("#serviceLi").addClass("active-link");
            $("#courierLi").addClass("active-service-menu-link");
        }
        ...
        if (fileName == "realtime-tracking") {
            $("#serviceLi").addClass("active-link");
            $("#ride-shareLi").addClass("active-service-menu-link");
        }
